...
| 23     | O usuário, como gold ou plus, pode dar likes ilimitados por dia                                                                                     | [Observação Participativa](observacao_participativa/) |
| 24     | O usuário, como gold, poderá ver de quem recebeu like.                                                                                              | [Observação Participativa](observacao_participativa/) |
| 25     | O usuário, como gold ou plus, poderá dar rewind ilimitadamente                                                                                      | [Observação Participativa](observacao_participativa/) |
| 26     | O usuário, como gold ou plus, não deve receber propaganda                                                                                           | [Observação Participativa](observacao_participativa/) |
| 27     | O usuário deve ser capaz de escolher a distância das pessoas que aparecem para ele.                                                                 | [Observação Participativa](observacao_participativa/) |
...
| 37     | O usuário, como gold ou plus, pode dar 5 super likes por dia                                                                                        | [Observação Participativa](observacao_participativa/) |
| 38     | O usuário, como gold ou plus, poderá escolher a localização.                                                                                        | [Observação Participativa](observacao_participativa/) |
| 39     | O usuário, como gold ou plus, poderá escolher a idade de quem pode ver ele                                                                          | [Observação Participativa](observacao_participativa/) |
| 40     | O usuário, como gold ou plus, poderá ser visto somente por quem ele deu like                                                                        | [Observação Participativa](observacao_participativa/) |
